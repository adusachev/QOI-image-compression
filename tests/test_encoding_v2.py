...
from qoi_encoder_v2 import *
import os


class TestEncodeBytePart(unittest.TestCase):
    ...
    def test(self):
        ...
        res = encode_byte_part(value, bits_num, right_offset, byte)
        self.assertEqual(res, 0b00011000, f"Should be 0b00011000, but get {bin(res)}")
